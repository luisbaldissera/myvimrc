...
inoremap <C-U> u
map  :FIGlet -ct -f term
map <silent>  :botright terminal
map <silent> 	 :tabnext
xmap <NL> dp
nmap <NL> ddp
smap <NL> ddp
...
xmap <C-J> dp
xmap <C-K> dkP
map <silent> <C-K>z :Goyo
map <silent> <S-Tab> :tabprevious
map <silent> <C-T> :tabnew .
map <silent> <C-Up> 
map <silent> <C-D> :botright terminal
map <F2> :FIGlet -t
map <C-Down> <NL>
nmap <C-J> ddp
smap <C-J> ddp
...
set ruler
set runtimepath=~/.vim,~/.vim/pack/styles/start/vim-theme-papaya,~/.vim/pack/styles/start/molokai,~/.vim/pack/styles/start/gruvbox,~/.vim/pack/plugins/start/vim-javascript,~/.vim/pack/plugins/start/vim-css-color,~/.vim/pack/plugins/start/vim-airline-themes,~/.vim/pack/plugins/start/vim-airline,~/.vim/pack/plugins/start/vim-FIGlet,~/.vim/pack/plugins/start/goyo.vim,~/.vim/pack/plugins/start/fzf,~/.vim/pack/plugins/start/emmet-vim,~/.vim/pack/plugins/start/coc.nvim,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,~/.vim/pack/plugins/start/vim-javascript/after,~/.vim/pack/plugins/start/vim-css-color/after,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets
set scrolloff=5
set shiftwidth=4
set showcmd
